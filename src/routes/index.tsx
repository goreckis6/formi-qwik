...
/**
 * Root path (/) always serves English content
 * This file handles ONLY the root path without locale prefix
 */
export const useLocaleLoader = routeLoader$(() => {
  const locale = 'en'; // Root path always English
          ...
          <div class="text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-12 sm:mb-16 px-4">
              ...
              >
                ...
                <svg class="w-5 h-5 sm:w-6 sm:h-6 relative z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <div class="group relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
              ...
              <div class="relative">
                ...
                <div class="text-3xl sm:text-4xl md:text-5xl font-black bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent mb-1 sm:mb-2">300+</div>
                <div class="text-gray-600 font-semibold text-base sm:text-lg">{home.stats.formats}</div>
              </div>
            </div>
            <div class="group relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
              ...
              <div class="relative">
                ...
                <div class="text-gray-600 font-semibold text-base sm:text-lg">{home.stats.dataProcessed}</div>
              </div>
            </div>
            <div class="group relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
              ...
              <div class="relative">
                ...
                <div class="text-3xl sm:text-4xl md:text-5xl font-black bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent mb-1 sm:mb-2">20 {t.nav.converters}</div>
                <div class="text-gray-600 font-semibold text-base sm:text-lg">{home.stats.batchFiles}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
            ...
            >
              ...
              <div class="relative">
                <div class="bg-gradient-to-br from-blue-500 to-indigo-600 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg group-hover:scale-110 transition-transform">
                  <svg class="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                  </svg>
                </div>
                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">{home.explore.converters.title}</h3>
                <p class="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 leading-relaxed">{home.explore.converters.description}</p>
                <div class="flex items-center gap-2 text-blue-600 font-semibold text-sm sm:text-base group-hover:gap-3 transition-all">
                  <span>Explore</span>
                  <svg class="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                  </svg>
                </div>
              </div>
            ...
            >
              ...
              <div class="relative">
                ...
                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">{home.explore.viewers.title}</h3>
                <p class="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 leading-relaxed">{home.explore.viewers.description}</p>
            ...
            >
              ...
              <div class="relative">
                ...
                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">{home.explore.compress.title}</h3>
                <p class="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 leading-relaxed">{home.explore.compress.description}</p>
            ...
            {/* Samples Card */}
            <Link 
              href={getLocalizedPath('/samples', locale)} 
            ...
            >
              ...
              <div class="relative">
                ...
                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">{home.explore.samples.title}</h3>
                <p class="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 leading-relaxed">{home.explore.samples.description}</p>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
            <div class="relative">
              ...
              <div class="relative bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border-2 border-blue-100 hover:border-blue-300 transition-all duration-300">
                ...
                <div class="text-center mb-3 sm:mb-4">
                  <span class="text-xs sm:text-sm font-bold text-blue-600 bg-blue-100 px-2.5 py-1 sm:px-3 sm:py-1 rounded-full">STEP 1</span>
                </div>
                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 text-center">{home.howItWorks.step1.title}</h3>
            ...
            <div class="relative">
              ...
              <div class="relative bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border-2 border-purple-100 hover:border-purple-300 transition-all duration-300">
                ...
                <div class="text-center mb-3 sm:mb-4">
                  <span class="text-xs sm:text-sm font-bold text-purple-600 bg-purple-100 px-2.5 py-1 sm:px-3 sm:py-1 rounded-full">STEP 2</span>
                </div>
                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 text-center">{home.howItWorks.step2.title}</h3>
                <p class="text-sm sm:text-base text-gray-600 text-center leading-relaxed">
            ...
            <div class="relative">
              ...
              <div class="relative bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border-2 border-green-100 hover:border-green-300 transition-all duration-300">
                ...
                <div class="text-center mb-3 sm:mb-4">
                  <span class="text-xs sm:text-sm font-bold text-green-600 bg-green-100 px-2.5 py-1 sm:px-3 sm:py-1 rounded-full">STEP 3</span>
                </div>
                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 text-center">{home.howItWorks.step3.title}</h3>
                <p class="text-sm sm:text-base text-gray-600 text-center leading-relaxed">
      ...
      <section class="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-12">
            {[
              { href: getLocalizedPath('/convert/heic-to-pdf', locale), title: 'HEIC to PDF', color: 'purple' },
              { href: getLocalizedPath('/convert/csv-to-json', locale), title: 'CSV to JSON', color: 'blue' },
              { href: getLocalizedPath('/convert/csv-to-ndjson', locale), title: 'CSV to NDJSON', color: 'indigo' },
              { href: getLocalizedPath('/convert/dng-to-webp', locale), title: 'DNG to WebP', color: 'pink' },
              { href: getLocalizedPath('/convert/cr2-to-webp', locale), title: 'CR2 to WebP', color: 'violet' },
              { href: getLocalizedPath('/convert/epub-to-pdf', locale), title: 'EPUB to PDF', color: 'red' },
              { href: getLocalizedPath('/convert/epub-to-mobi', locale), title: 'EPUB to MOBI', color: 'emerald' },
              { href: getLocalizedPath('/convert/csv-to-xlsx', locale), title: 'CSV to XLSX', color: 'teal' },
              { href: getLocalizedPath('/convert/docx-to-pdf', locale), title: 'DOCX to PDF', color: 'slate' },
            ].map((converter, index) => (
              <Link 
                key={index}
                href={converter.href} 
              ...
              >
                <div class={`absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-${converter.color}-100 to-${converter.color}-200 rounded-full -mr-8 -mt-8 sm:-mr-10 sm:-mt-10 opacity-50 group-hover:opacity-75 transition-opacity`}></div>
                <div class={`inline-flex p-2 sm:p-3 rounded-lg sm:rounded-xl bg-gradient-to-br from-${converter.color}-500 to-${converter.color}-600 mb-3 sm:mb-4 group-hover:scale-110 transition-transform`}>
                  <svg class="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <h3 class="font-bold text-gray-900 mb-1 text-xs sm:text-sm group-hover:text-gray-700 transition-colors">{converter.title}</h3>
              </Link>
            ))}
          </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {[
              ...
              <div key={index} class="group relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-gray-100 hover:border-gray-200 overflow-hidden">
                <div class={`absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br ${feature.bgGradient} rounded-full -mr-12 -mt-12 sm:-mr-16 sm:-mt-16 opacity-50 group-hover:opacity-75 transition-opacity`}></div>
                <div class="relative">
                  <div class={`inline-flex p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-br ${feature.gradient} mb-4 sm:mb-6 shadow-lg group-hover:scale-110 transition-transform`}>
                    <svg class="w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      {feature.icon === 'zap' && <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />}
                      {feature.icon === 'shield' && <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />}
                      {feature.icon === 'globe' && <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />}
                      {feature.icon === 'bar-chart' && <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />}
                      {feature.icon === 'eye' && (
                        <>
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                      ...
                      {feature.icon === 'star' && <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />}
                    </svg>
                  </div>
...
export const head: DocumentHead = ({ resolveValue }) => {
  ...
  const home = localeData.translations.home;
