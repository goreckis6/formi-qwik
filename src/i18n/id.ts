...
export const id: Translations = {
  ...
  jpgToBmp: {
    title: "Konverter JPG ke BMP - Ubah Gambar ke Windows Bitmap Gratis",
    metaDescription:
      "Konversi JPG ke BMP secara instan. Konverter JPG ke BMP gratis dengan dukungan batch. Cepat, aman, tanpa registrasi. Cocok untuk kompatibilitas Windows dan kualitas tanpa kompresi.",
    metaKeywords:
      "JPG ke BMP, konversi JPG ke BMP, gambar ke BMP, foto ke BMP, batch JPG, konverter BMP, konverter BMP gratis, Windows bitmap",
    hero: {
      title: "Konverter JPG ke BMP",
      subtitle:
        "Ubah JPG ke format Windows BMP dengan cepat. BMP adalah format tanpa kompresi untuk kualitas maksimal dan kompatibilitas Windows. Gratis, cepat, aman.",
      badge1: "Kualitas Tanpa Kompresi",
      badge2: "Kompatibel Windows",
      badge3: "Tanpa Registrasi",
    },
    upload: {
      title: "Unggah File JPG",
    ...
    features: {
      title: "Fitur",
      list: [
        "Konversi JPG ke BMP berkualitas tinggi",
        "Pemrosesan batch hingga 20 file",
        "Format tanpa kompresi menjaga kualitas maksimal",
        "Kompatibilitas Windows sempurna",
        "100% aman dengan penghapusan otomatis",
    ...
    howItWorks: {
      title: "Cara Kerja",
      step1Title: "Unggah File JPG",
      step1Desc: "Pilih satu atau beberapa gambar JPG",
      step2Title: "Konversi Otomatis",
      step2Desc: "File diproses secara instan",
      step3Title: "Unduh BMP",
      step3Desc: "Dapatkan file BMP segera",
    },
    about: {
      title: "Tentang Konversi JPG ke BMP",
      whatIsHeif: {
      ...
      benefits: {
        ...
        list: [
          "Kualitas tanpa kompresi",
          "Dukungan native Windows",
          "Kompatibilitas tinggi",
          "Tidak ada kehilangan kualitas",
          "Format sederhana",
          "Mendukung hingga 32-bit warna",
        ],
      },
    },
    faq: {
      title: "Pertanyaan Umum – JPG ke BMP",
      items: [
        {
    ...
    related: {
      ...
      converters: [
        { name: "JPG ke PNG", url: "/convert/jpg-to-png" },
        { name: "PNG ke BMP", url: "/convert/png-to-bmp" },
        { name: "BMP ke PNG", url: "/convert/bmp-to-png" },
      ],
    },
