...
export const pt: EnTranslations = {
  ...
  heifToAvif: {
    title: "Conversor HEIF para AVIF - Converta Imagens HEIF para AVIF Grátis Online",
    metaDescription:
      "Converta imagens HEIF para formato AVIF instantaneamente. Conversor online gratuito HEIF para AVIF com processamento em lote. Rápido, seguro e sem registro necessário. Funciona com fotos HEIF de todos os dispositivos.",
    metaKeywords:
      "HEIF para AVIF, converter HEIF, imagens HEIF para AVIF, conversor HEIF, imagem para AVIF, conversão em lote HEIF, conversor HEIF gratuito, HEIF vs HEIC",
    hero: {
  ...
  heifToWebp: {
    title: "Conversor HEIF para WebP - Converta Imagens HEIF para WebP Grátis Online",
    metaDescription:
      "Converta imagens HEIF para formato WebP instantaneamente. Conversor online gratuito HEIF para WebP com processamento em lote. Rápido, seguro e sem registro necessário. Funciona com fotos HEIF de todos os dispositivos.",
    metaKeywords:
      "HEIF para WebP, converter HEIF, imagens HEIF para WebP, conversor HEIF, imagem para WebP, conversão em lote HEIF, conversor HEIF gratuito, HEIF vs HEIC",
    hero: {
