...
export const tr: Translations = {
  ...
  jpgToBmp: {
    title: "JPG'den BMP'ye Dönüştürücü - Görselleri Windows Bitmap'e Ücretsiz Çevirin",
    metaDescription:
      "JPG görselleri anında BMP formatına dönüştürün. Toplu işlem destekli ücretsiz JPG→BMP dönüştürücü. Hızlı, güvenli ve kayıt gerektirmez. Windows uyumluluğu ve sıkıştırmasız kalite için ideal.",
    metaKeywords:
      "JPG BMP dönüştürme, JPG'den BMP'ye, görüntüden BMP, foto BMP, toplu JPG dönüştürme, BMP dönüştürücü, ücretsiz BMP dönüştürücü, Windows bitmap",
    hero: {
      title: "JPG'den BMP'ye Dönüştürücü",
      subtitle:
        "JPG görselleri Windows BMP formatına anında dönüştürün. BMP (Bitmap) sıkıştırmasız bir formattır ve maksimum kalite ile Windows uyumluluğu sağlar. Ücretsiz, hızlı ve güvenli.",
      badge1: "Sıkıştırmasız Kalite",
      badge2: "Windows Uyumlu",
      badge3: "Kayıt Yok",
    },
    upload: {
      ...
      success: "Dönüştürme başarılı!",
      download: "BMP İndir",
      downloadAll: "Hepsini ZIP İndir",
      convertAnother: "Başka Dosya Dönüştür",
    },
    features: {
      title: "Özellikler",
      list: [
        "Yüksek kaliteli JPG→BMP dönüşümü",
        "20 dosyaya kadar toplu işlem",
        "Sıkıştırmasız format maksimum kalite sağlar",
        "Mükemmel Windows uyumluluğu",
        "Dosyalar otomatik silinir - %100 güvenli",
        "Dönüşümde kalite kaybı yok",
        "Anında indirme - kullanıma hazır",
        "Filigran yok - profesyonel kalite",
      ],
    },
    howItWorks: {
      title: "Nasıl Çalışır",
      step1Title: "JPG Dosyalarını Yükleyin",
      step1Desc: "Cihazınızdan bir veya daha fazla JPG seçin",
      step2Title: "Otomatik Dönüştürme",
      step2Desc: "Dönüştürücü dosyaları anında işler",
      step3Title: "BMP İndirin",
      step3Desc: "BMP dosyalarını hemen indirin",
    },
    about: {
      title: "JPG'den BMP'ye Dönüştürme Hakkında",
      whatIsHeif: {
      ...
      benefits: {
        ...
        list: [
          "Sıkıştırmasız kalite - artefakt yok",
          "Windows yerel desteği",
          "Yüksek uyumluluk",
          "Kalite kaybı yok",
          "Basit format - kolay işlenir",
          "32-bit'e kadar renk derinliği",
        ],
      },
    },
    faq: {
      title: "Sık Sorulan Sorular – JPG'den BMP'ye",
      items: [
        {
    ...
    related: {
      ...
      converters: [
        { name: "JPG'den PNG'ye", url: "/convert/jpg-to-png" },
        { name: "PNG'den BMP'ye", url: "/convert/png-to-bmp" },
        { name: "BMP'den PNG'ye", url: "/convert/bmp-to-png" },
      ],
    },
