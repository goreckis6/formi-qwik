...
export const fr: Translations = {
  ...
  jpgToBmp: {
    title: "Convertisseur JPG vers BMP - Convertir des Images au Format Windows Bitmap Gratuitement",
    metaDescription:
      "Convertissez des images JPG en BMP instantanément. Convertisseur JPG vers BMP gratuit en ligne avec traitement par lots. Rapide, sécurisé et sans inscription. Idéal pour la compatibilité Windows et la qualité sans compression.",
    metaKeywords:
      "JPG vers BMP, convertir JPG en BMP, image en BMP, photo en BMP, conversion par lots JPG, convertisseur BMP, convertisseur BMP gratuit, Windows bitmap",
    hero: {
      title: "Convertisseur JPG vers BMP",
      subtitle:
        "Convertissez des images JPG au format Windows BMP instantanément. BMP (Bitmap) est un format d'image non compressé idéal pour la compatibilité Windows et la préservation maximale de la qualité. Conversion gratuite, rapide et sécurisée.",
      badge1: "Qualité Sans Compression",
      badge2: "Compatible Windows",
      badge3: "Sans Inscription",
    },
    upload: {
      title: "Téléverser des Fichiers JPG",
      description:
        "Glissez-déposez vos images JPG ici ou cliquez pour parcourir. Prend en charge jusqu'à 20 fichiers en lot. Maximum 100 Mo par fichier.",
      batchTitle: "Glissez-déposez vos photos JPG ici ou cliquez pour parcourir",
      batchDescription:
        "Prend en charge la conversion par lots jusqu'à 20 fichiers. Maximum 100 Mo par fichier.",
      buttonSingle: "Fichier Unique",
      buttonBatch: "Conversion par Lots",
      chooseFile: "Choisir des Fichiers",
      converting: "Conversion en cours...",
      success: "Conversion réussie !",
      download: "Télécharger BMP",
      downloadAll: "Tout Télécharger en ZIP",
      convertAnother: "Convertir un Autre Fichier",
    },
    features: {
      title: "Fonctionnalités",
      list: [
        "Conversion JPG vers BMP de haute qualité",
        "Traitement par lots jusqu'à 20 fichiers simultanément",
        "Format non compressé préservant la qualité maximale",
        "Compatibilité Windows parfaite",
        "100 % sécurisé avec suppression automatique des fichiers",
        "Aucune perte de qualité pendant la conversion",
        "Téléchargement instantané - prêt à l'emploi",
        "Sans filigrane - qualité professionnelle",
      ],
    },
    howItWorks: {
      title: "Comment Ça Marche",
      step1Title: "Téléverser des Fichiers JPG",
      step1Desc: "Sélectionnez une ou plusieurs images JPG depuis votre appareil",
      step2Title: "Conversion Automatique",
      step2Desc: "Notre convertisseur traite vos fichiers instantanément",
      step3Title: "Télécharger BMP",
      step3Desc: "Obtenez vos fichiers BMP convertis immédiatement",
    },
    about: {
      title: "À Propos de la Conversion JPG vers BMP",
      whatIsHeif: {
        title: "Qu'est-ce que le Format BMP ?",
        content:
          "BMP (Bitmap Image File) est un format d'image raster développé par Microsoft pour Windows. Les fichiers BMP ne sont pas compressés, ce qui signifie qu'ils préservent chaque pixel de l'image d'origine sans artefacts de compression. Bien que les fichiers BMP soient plus volumineux que les formats compressés comme JPG, ils offrent une qualité maximale et sont universellement pris en charge par Windows. Le format BMP prend en charge différentes profondeurs de couleur (1, 4, 8, 16, 24 et 32 bits) et convient aux applications nécessitant des données d'image non compressées.",
      },
      whyConvert: {
        title: "Pourquoi Convertir JPG en BMP ?",
        content:
          "Convertissez JPG en BMP lorsque vous avez besoin d'une qualité d'image non compressée ou d'une compatibilité spécifique à Windows. JPG utilise une compression avec perte qui réduit définitivement la qualité, tandis que BMP est non compressé et conserve chaque pixel. Raisons clés : préserver la qualité maximale (sans artefacts), assurer la compatibilité Windows (prise en charge native BMP), préparer des images pour des applications Windows (souvent préférées en BMP), archiver sans perte de qualité, ou utiliser des images sur des systèmes hérités.",
      },
      heifVsHeic: {
        title: "BMP vs JPG - Quand Choisir BMP",
        content:
          "BMP et JPG servent à des usages différents. Choisissez BMP pour : qualité non compressée (préservation parfaite des pixels), applications Windows, archivage sans perte, développement logiciel, systèmes hérités, ou exigences de précision. Choisissez JPG pour : usage web (fichiers plus petits), partage en ligne, réseaux sociaux, photographie générale, ou quand la taille compte.",
      },
      benefits: {
        title: "Avantages du Format BMP",
        list: [
          "Qualité Sans Compression - Aucun artefact, préservation parfaite des pixels",
          "Natif Windows - Support intégré sur tous les systèmes Windows",
          "Compatibilité Maximale - Fonctionne avec toutes les applications Windows",
          "Aucune Perte de Qualité - Préserve chaque pixel de l'image d'origine",
          "Format Simple - Facile à lire et à traiter par logiciel",
          "Support de Profondeur de Couleur - Jusqu'à 32 bits",
        ],
      },
    },
    faq: {
      title: "Questions Fréquemment Posées – JPG vers BMP",
      items: [
        {
          q: "La conversion JPG en BMP est-elle gratuite ?",
          a: "Oui ! Notre convertisseur JPG vers BMP est entièrement gratuit avec des conversions illimitées. Aucune inscription, abonnement ou frais cachés. Convertissez autant d'images que nécessaire pour les applications Windows ou à des fins d'archivage.",
        },
        {
          q: "Les fichiers BMP seront-ils plus volumineux que les fichiers JPG ?",
          a: "Oui, les fichiers BMP sont généralement 3 à 10 fois plus volumineux que les fichiers JPG car BMP n'est pas compressé tandis que JPG utilise une compression avec perte. Cependant, BMP préserve chaque pixel parfaitement sans perte de qualité, ce qui le rend idéal pour les applications nécessitant une qualité d'image maximale.",
        },
        {
          q: "La qualité de l'image sera-t-elle préservée lors de la conversion JPG en BMP ?",
          a: "Le format BMP préserve les données d'image du fichier JPG, mais comme JPG utilise une compression avec perte, une certaine qualité peut déjà avoir été perdue dans le JPG original. La conversion en BMP empêche toute perte de qualité supplémentaire et préserve parfaitement la qualité d'image actuelle. Pour de meilleurs résultats, commencez avec des images JPG de haute qualité.",
        },
        {
          q: "Puis-je utiliser des fichiers BMP sur des systèmes autres que Windows ?",
          a: "Oui, les fichiers BMP peuvent être ouverts sur macOS, Linux et d'autres systèmes d'exploitation, bien qu'ils soient le plus souvent associés à Windows. La plupart des visionneuses et éditeurs d'images prennent en charge le format BMP sur toutes les plateformes.",
        },
        {
          q: "Quelle est la taille maximale de fichier pour la conversion JPG en BMP ?",
          a: "Vous pouvez convertir des fichiers JPG jusqu'à 100 Mo chacun. Pour la conversion par lots, vous pouvez téléverser jusqu'à 20 fichiers à la fois, avec une limite de taille totale de 100 Mo. Notez que les fichiers BMP résultants seront plus volumineux que les fichiers JPG originaux.",
        },
        {
          q: "Pourquoi choisirais-je BMP plutôt que JPG ?",
          a: "Choisissez BMP lorsque vous avez besoin d'une qualité non compressée, d'une compatibilité spécifique à Windows, ou lorsque vous travaillez avec des applications nécessitant le format BMP. BMP est idéal pour l'archivage, le développement de logiciels Windows, et les situations où la qualité d'image maximale est plus importante que la taille du fichier. Pour l'utilisation web ou le partage général, JPG est généralement plus pratique en raison de tailles de fichier plus petites.",
        },
        {
          q: "Combien de temps prend la conversion JPG en BMP ?",
          a: "La conversion prend 1 à 2 secondes par image. La conversion BMP est rapide car il s'agit principalement d'un changement de format. Le résultat est un fichier BMP non compressé prêt pour les applications Windows ou l'utilisation d'archivage.",
        },
      ],
    },
    related: {
      ...
      converters: [
        { name: "JPG vers PNG", url: "/convert/jpg-to-png" },
        { name: "PNG vers BMP", url: "/convert/png-to-bmp" },
        { name: "BMP vers PNG", url: "/convert/bmp-to-png" },
      ],
    },
  },
