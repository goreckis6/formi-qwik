  ...
  jpgToBmp: {
    ...
    about: {
      ...
      whatIsHeif: {
        title: "什么是 BMP 格式？",
        content:
          "BMP（位图）是 Microsoft 为 Windows 开发的光栅图像格式。BMP 文件不压缩，能够完整保留每个像素而无压缩伪影。虽然文件更大，但质量最高，且在 Windows 中广泛兼容。",
      },
      whyConvert: {
        title: "为什么将 JPG 转为 BMP？",
        content:
          "当你需要无压缩质量或 Windows 兼容性时，建议使用 BMP。JPG 为有损压缩，而 BMP 保留每个像素。适用于 Windows 应用、无损归档和高精度图像处理。",
      },
      heifVsHeic: {
        title: "BMP vs JPG - 何时选择 BMP",
        content:
          "BMP 适用于质量优先、Windows 应用与归档；JPG 更适合网页与较小文件体积。",
      },
      benefits: {
        title: "BMP 格式优势",
        list: [
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: "BMP 文件会比 JPG 大吗？",
          a: "会，通常大 3–10 倍，因为 BMP 不压缩。",
        },
        {
          q: "转换会影响画质吗？",
          a: "BMP 会保留 JPG 的图像数据，不会产生额外损失。",
        },
        {
          q: "BMP 可以在非 Windows 系统使用吗？",
          a: "可以，macOS 和 Linux 也可打开。",
        },
        {
          q: "最大文件大小是多少？",
          a: "单文件最大 100MB，批量最多 20 个文件。",
        },
        {
          q: "为什么选择 BMP 而不是 JPG？",
          a: "当你需要无压缩质量或 Windows 兼容性时，BMP 更合适。",
        },
        {
          q: "转换需要多久？",
          a: "通常每张 1–2 秒，属于快速格式转换。",
        },
      ],
    },
    related: {
