...
export const nl: Translations = {
  ...
  jpgToBmp: {
    title: "JPG naar BMP Converter - Zet Afbeeldingen Gratis om naar Windows Bitmap",
    metaDescription:
      "Converteer JPG-afbeeldingen direct naar BMP. Gratis JPG-naar-BMP converter met batchverwerking. Snel, veilig en zonder registratie. Ideaal voor Windows-compatibiliteit en ongecomprimeerde kwaliteit.",
    metaKeywords:
      "JPG naar BMP, JPG converteren naar BMP, afbeelding naar BMP, foto naar BMP, batch JPG converteren, BMP converter, gratis BMP converter, Windows bitmap",
    hero: {
      title: "JPG naar BMP Converter",
      subtitle:
        "Converteer JPG-afbeeldingen direct naar Windows BMP. BMP (Bitmap) is een ongecomprimeerd beeldformaat voor maximale kwaliteit en Windows-compatibiliteit. Gratis, snel en veilig.",
      badge1: "Ongecomprimeerde Kwaliteit",
      badge2: "Windows-compatibel",
      badge3: "Geen Registratie",
    },
    upload: {
      title: "Upload JPG Bestanden",
    ...
    features: {
      title: "Functies",
      list: [
        "Hoge kwaliteit JPG naar BMP conversie",
        "Batchverwerking tot 20 bestanden tegelijk",
        "Ongecomprimeerd formaat behoudt maximale kwaliteit",
        "Perfecte Windows-compatibiliteit",
        "100% veilig met automatische bestandsverwijdering",
    ...
    about: {
      title: "Over JPG naar BMP Conversie",
      whatIsHeif: {
      ...
      benefits: {
        ...
        list: [
          "Ongecomprimeerde kwaliteit - geen artefacten",
          "Windows-natief - ingebouwde ondersteuning",
          "Maximale compatibiliteit - werkt overal in Windows",
          "Geen kwaliteitsverlies - elke pixel blijft behouden",
          "Eenvoudig formaat - makkelijk te verwerken",
          "Ondersteunt kleurdieptes tot 32-bit",
        ],
      },
    },
    faq: {
      title: "Veelgestelde Vragen – JPG naar BMP",
      items: [
        {
    ...
    related: {
      ...
      converters: [
        { name: "JPG naar PNG", url: "/convert/jpg-to-png" },
        { name: "PNG naar BMP", url: "/convert/png-to-bmp" },
        { name: "BMP naar PNG", url: "/convert/bmp-to-png" },
      ],
    },
  },
