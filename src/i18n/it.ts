...
export const it: Translations = {
  ...
  heicToPng: {
    ...
    heicToJpg: {
      ...
      metaDescription: 'Converti immagini HEIC in formato JPG istantaneamente. Convertitore online gratuito HEIC a JPG con elaborazione batch. Veloce, sicuro e senza registrazione richiesta. Funziona con foto iPhone e iPad.',
      metaKeywords: 'HEIC a JPG, converti HEIC, foto Apple a JPG, foto iPhone a JPG, convertitore HEIC, immagine a JPG, conversione batch HEIC, convertitore HEIC gratuito',
      
      hero: {
        title: 'Convertitore HEIC a JPG',
        subtitle: 'Trasforma le tue foto Apple HEIC in immagini JPG universali istantaneamente. Conversione gratuita, veloce e sicura senza limiti di dimensione file.',
        badge1: 'Lampo Veloce',
        badge2: '100% Sicuro',
      ...
      about: {
        ...
        whatIsHeic: {
          title: 'Cos\'è il Formato HEIC?',
          content: 'HEIC (High Efficiency Image Container) è il formato foto predefinito utilizzato dai dispositivi Apple da iOS 11. Offre compressione superiore mantenendo alta qualità dell\'immagine, facendo sì che le foto occupino meno spazio di archiviazione sul tuo iPhone o iPad.',
        },
        whyConvert: {
