...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Browse and use our 300+ file format converters. Convert images, documents, ebooks, and data files instantly. Free, fast, and secure conversion.",
    },
    {
      name: "keywords",
    ...
    },
    {
      ...
      content: "Browse and use our 300+ file format converters. Convert images, documents, ebooks, and more.",
    },
    {
      name: "twitter:card",
