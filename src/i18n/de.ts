...
export const de: Translations = {
  ...
  heicToPdf: {
    ...
    howItWorks: {
      ...
      step1Desc: "Wählen Sie ein oder mehrere JPG-Bilder von Ihrem Gerät aus",
  ...
  jpgToPng: {
    ...
    metaDescription:
      "Konvertieren Sie JPG zu PNG für Transparenzunterstützung und verlustfreie Qualität. Perfekt für Logos, Grafiken und Webbilder. Qualität ohne Kompressionsfehler bewahren. Kostenloser Batch-Konverter, keine Registrierung.",
    metaKeywords:
      "JPG zu PNG, Transparenz hinzufügen, verlustfreie Konvertierung, Grafikkonverter, Logo-Konverter, Webbilder, Batch JPG konvertieren, Hintergrund entfernen",
    hero: {
      title: "JPG zu PNG Konverter",
      subtitle:
        "Konvertieren Sie JPG zu PNG für Transparenzunterstützung und überlegene Qualität. Perfekt für Logos, Grafiken und professionelle Bilder. PNG bewahrt jedes Detail ohne Kompressionsartefakte - ideal für Webgrafiken, Overlays und Bilder mit transparentem Hintergrund.",
      badge1: "Transparenzunterstützung",
  ...
  heifToGif: {
    ...
    metaDescription:
      "Konvertieren Sie HEIF zu GIF für universelles Teilen und Animationen. Perfekt für Social Media, Memes und Websites. Funktioniert überall - keine App benötigt. Erstellen Sie animierte GIFs aus Fotos. Kostenloser Batch-Konverter.",
    metaKeywords:
      "HEIF zu GIF, animiertes GIF, Social Media Sharing, Memes, universelle Kompatibilität, GIF-Animation, Batch HEIF konvertieren, teilbare Bilder",
    hero: {
