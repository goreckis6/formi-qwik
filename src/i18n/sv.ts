...
export const sv: Translations = {
  ...
  jpgToBmp: {
    title: "JPG till BMP-konverterare - Konvertera bilder till Windows Bitmap gratis",
    metaDescription:
      "Konvertera JPG-bilder till BMP direkt. Gratis JPG till BMP-konverterare med batchbehandling. Snabbt, säkert och utan registrering. Perfekt för Windows-kompatibilitet och okomprimerad kvalitet.",
    metaKeywords:
      "JPG till BMP, konvertera JPG till BMP, bild till BMP, foto till BMP, batchkonvertering JPG, BMP-konverterare, gratis BMP-konverterare, Windows bitmap",
    hero: {
      title: "JPG till BMP-konverterare",
      subtitle:
        "Konvertera JPG-bilder till Windows BMP direkt. BMP (Bitmap) är ett okomprimerat bildformat för maximal kvalitet och Windows-kompatibilitet. Gratis, snabbt och säkert.",
      badge1: "Okomprimerad kvalitet",
    ...
    upload: {
      ...
      converting: "Konverterar...",
      success: "Konvertering lyckades!",
      download: "Ladda ner BMP",
      downloadAll: "Ladda ner allt som ZIP",
      convertAnother: "Konvertera en till fil",
    },
    features: {
      title: "Funktioner",
      list: [
        "Högkvalitativ JPG till BMP-konvertering",
        "Batchbehandling upp till 20 filer samtidigt",
        "Okomprimerat format bevarar maximal kvalitet",
        "Perfekt Windows-kompatibilitet",
        "100% säker med automatisk radering",
        "Ingen kvalitetsförlust vid konvertering",
        "Direkt nedladdning - redo att användas",
        "Inga vattenstämplar - professionell kvalitet",
      ],
    },
    howItWorks: {
      ...
      step1Desc: "Välj en eller flera JPG-bilder från din enhet",
      step2Title: "Automatisk konvertering",
      step2Desc: "Vår konverterare bearbetar filerna direkt",
      step3Title: "Ladda ner BMP",
      step3Desc: "Hämta dina konverterade BMP-filer direkt",
    },
    about: {
      title: "Om JPG till BMP-konvertering",
      whatIsHeif: {
      ...
      benefits: {
        ...
        list: [
          "Okomprimerad kvalitet – inga artefakter",
          "Windows-nativt – inbyggt stöd",
          "Maximal kompatibilitet – fungerar i Windows-appar",
          "Ingen kvalitetsförlust – varje pixel bevaras",
          "Enkelt format – lätt att bearbeta",
          "Färgdjup upp till 32-bit",
        ],
      },
    },
    faq: {
      title: "Vanliga frågor – JPG till BMP",
      items: [
        {
    ...
    related: {
      ...
      converters: [
        { name: "JPG till PNG", url: "/convert/jpg-to-png" },
        { name: "PNG till BMP", url: "/convert/png-to-bmp" },
        { name: "BMP till PNG", url: "/convert/bmp-to-png" },
      ],
    },
