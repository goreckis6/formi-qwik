...
export const sv: Translations = {
  ...
  heicToPng: {
    ...
    heicToJpg: {
      ...
      metaDescription: 'Konvertera HEIC-bilder direkt till JPG-format. Gratis online HEIC till JPG-konverterare med batchbearbetning. Snabb, säker och ingen registrering krävs. Fungerar med iPhone- och iPad-foton.',
      metaKeywords: 'HEIC till JPG, konvertera HEIC, Apple foton till JPG, iPhone foton till JPG, HEIC-konverterare, bild till JPG, batch konvertera HEIC, gratis HEIC-konverterare',
      
      hero: {
        title: 'HEIC till JPG-konverterare',
        subtitle: 'Konvertera dina Apple HEIC-foton direkt till universella JPG-bilder. Gratis, snabb och säker konvertering utan filstorleksbegränsningar.',
        badge1: 'Blixtsnabb',
        badge2: '100% Säker',
        badge3: 'Ingen Registrering',
      },
