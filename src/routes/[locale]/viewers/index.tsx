...
export const head: DocumentHead = ({ resolveValue, url }) => {
  ...
  return {
    title: t.viewers.metaTitle,
    meta: [
      {
        name: "description",
        content: t.viewers.metaDescription,
      },
      {
        name: "keywords",
        content: t.viewers.metaKeywords,
      },
      {
        property: "og:type",
        content: "website",
      ...
      {
        name: "twitter:title",
        content: t.viewers.title,
      },
      {
        name: "twitter:description",
        content: t.viewers.subtitle,
      },
    ],
  };
};
