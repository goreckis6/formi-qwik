      ...
      <section class="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-8 sm:mb-12">
            {[
              { href: getLocalizedPath('/convert/heic-to-pdf', 'en'), title: 'HEIC to PDF', color: 'purple' },
              { href: getLocalizedPath('/convert/csv-to-json', 'en'), title: 'CSV to JSON', color: 'blue' },
              { href: getLocalizedPath('/convert/csv-to-ndjson', 'en'), title: 'CSV to NDJSON', color: 'indigo' },
              { href: getLocalizedPath('/convert/dng-to-webp', 'en'), title: 'DNG to WebP', color: 'pink' },
              { href: getLocalizedPath('/convert/cr2-to-webp', 'en'), title: 'CR2 to WebP', color: 'violet' },
              { href: getLocalizedPath('/convert/epub-to-pdf', 'en'), title: 'EPUB to PDF', color: 'red' },
              { href: getLocalizedPath('/convert/epub-to-mobi', 'en'), title: 'EPUB to MOBI', color: 'emerald' },
              { href: getLocalizedPath('/convert/csv-to-xlsx', 'en'), title: 'CSV to XLSX', color: 'teal' },
              { href: getLocalizedPath('/convert/docx-to-pdf', 'en'), title: 'DOCX to PDF', color: 'slate' },
            ].map((converter, index) => (
              <Link 
                key={index}
                href={converter.href} 
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Convert files between 300+ formats instantly. Fast, secure, and free file conversion service. Support for images, documents, ebooks, and data files.",
    },
    {
      name: "keywords",
      content: "file converter, online converter, image converter, document converter, ebook converter, batch conversion, free converter",
    },
    // Open Graph / Facebook
    {
      property: "og:type",
