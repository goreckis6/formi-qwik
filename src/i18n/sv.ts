...
export const sv: Translations = {
  ...
  viewers: {
    title: "Filvisare",
    metaTitle: "Filvisare - Förhandsgranska i Webbläsaren | FormiPeek",
    metaDescription: "Visa filer direkt i din webbläsare. Ingen nedladdning krävs. Stöd för bilder, dokument, PDF och mer.",
    metaKeywords: "filvisare, online visare, PDF visare, bildvisare, filförhandsgranskning",
    subtitle: "Visa filer direkt i din webbläsare. Ingen nedladdning krävs.",
    cardTitle: "Filvisare",
    cardDescription: "Visa filer direkt i webbläsaren utan nedladdning. Stöd för bilder, dokument, PDF och fler format.",
  ...
  compress: {
    ...
    metaTitle: "Filkomprimering - Komprimera Bilder och PDF Online | FormiPeek",
    metaDescription: "Komprimera bilder och PDF utan kvalitetsförlust. Snabba och gratis komprimeringsverktyg. Minska filstorlekar.",
    metaKeywords: "filkomprimering, komprimera bilder, komprimera PDF, bildkompressor, minska filstorlek",
    subtitle: "Minska filstorlekar utan kvalitetsförlust. Snabbt och gratis.",
    cardTitle: "Filkomprimering",
    cardDescription: "Komprimera bilder och PDF utan kvalitetsförlust. Minska filstorlekar för snabbare uppladdningar. Stöd för JPG, PNG och PDF.",
    comingSoon: "Kommer snart...",
  },
  ...
  samples: {
    title: "Exempelfiler",
    metaTitle: "Exempelfiler - Ladda Ner Testfiler | FormiPeek",
    metaDescription: "Ladda ner exempelfiler i olika format för att testa våra konverteringsverktyg. Testa innan du konverterar.",
    metaKeywords: "exempelfiler, testfiler, filexempel, ladda ner exempel, konverteringstest",
    subtitle: "Bläddra bland exempelfiler för alla format som stöds. Testa innan du konverterar.",
    cardTitle: "Exempelfiler",
    cardDescription: "Ladda ner exempelfiler i olika format för att testa våra verktyg. Testa med verkliga exempel innan du konverterar.",
    comingSoon: "Kommer snart...",
  },
};